...
export const DeleteContainer = ({
  ...
  return (
    <>
      <div className="deleteContainer" style={themeStyle} data-testid="deleteCon">
        <article className="font-bold">Delete this {deleteContainerTitle}</article>
        <p className="deleteText font-medium leading-6">{deleteContainerText}</p>
